...
[Documentation](https://raw.githubusercontent.com/Christian-Me/obsidian-front-matter-automate/main/doc/README.md) / [rules/buildInDefault](https://raw.githubusercontent.com/Christian-Me/obsidian-front-matter-automate/main/doc/rules/buildInDefault/README.md) / RuleBuildInDefault

# Class: RuleBuildInDefault

Defined in: [src/rules/buildInDefault.ts:29](https://github.com/Christian-Me/folder-to-tags-plugin/blob/ea97d76ce7b235ca1e3494401efc98e537acc1fb/src/rules/buildInDefault.ts#L29)
...
> **new RuleBuildInDefault**(): `RuleBuildInDefault`

Defined in: [src/rules/buildInDefault.ts:30](https://github.com/Christian-Me/folder-to-tags-plugin/blob/ea97d76ce7b235ca1e3494401efc98e537acc1fb/src/rules/buildInDefault.ts#L30)
...
The unique identifier for the rule, set to `'default'`.
...
The display name of the rule, set to `'Pass parameter unaltered'`.
...
The type of the rule, set to `'buildIn'`.
...
The supported types for this rule, including `text`, `tags`, `aliases`, and `multitext`.
...
Defined in: [src/rules/buildInDefault.ts:46](https://github.com/Christian-Me/folder-to-tags-plugin/blob/ea97d76ce7b235ca1e3494401efc98e537acc1fb/src/rules/buildInDefault.ts#L46)

A method for rendering the configuration tab for the rule.
...
Defined in: [src/rules/buildInDefault.ts:41](https://github.com/Christian-Me/folder-to-tags-plugin/blob/ea97d76ce7b235ca1e3494401efc98e537acc1fb/src/rules/buildInDefault.ts#L41)

The main function that processes the input content and returns it unaltered.
