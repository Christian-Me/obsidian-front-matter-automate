...
[Documentation](https://raw.githubusercontent.com/Christian-Me/obsidian-front-matter-automate/main/doc/README.md) / [rules/toLinkWiki](https://raw.githubusercontent.com/Christian-Me/obsidian-front-matter-automate/main/doc/rules/toLinkWiki/README.md) / RuleToLinkWiki

# Class: RuleToLinkWiki

Defined in: [src/rules/toLinkWiki.ts:36](https://github.com/Christian-Me/folder-to-tags-plugin/blob/ea97d76ce7b235ca1e3494401efc98e537acc1fb/src/rules/toLinkWiki.ts#L36)
...
> **new RuleToLinkWiki**(): `RuleToLinkWiki`

Defined in: [src/rules/toLinkWiki.ts:37](https://github.com/Christian-Me/folder-to-tags-plugin/blob/ea97d76ce7b235ca1e3494401efc98e537acc1fb/src/rules/toLinkWiki.ts#L37)
...
The unique identifier for the rule (`toWikiLink`).
...
The display name of the rule (`wiki link`).
...
The type of rule (`linkFormatter`).
...
The source code template for the rule's functionality.
...
The applicable input types for the rule 
...
Defined in: [src/rules/toLinkWiki.ts:48](https://github.com/Christian-Me/folder-to-tags-plugin/blob/ea97d76ce7b235ca1e3494401efc98e537acc1fb/src/rules/toLinkWiki.ts#L48)

The function that applies the rule logic, converting
