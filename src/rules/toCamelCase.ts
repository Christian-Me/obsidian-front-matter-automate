 ...
 * @property {Function} fx - The function that performs the Camel Case transformation.
 */
export class RuleToCamelCase extends RulePrototype {
    constructor() {
        super();
        this.id = 'toCamelCase';
...
//rulesManager.registerRule(new RuleToCamelCase());